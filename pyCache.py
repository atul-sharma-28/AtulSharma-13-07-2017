...
class initApp(tk.Frame):
    ...
    def createWidgets(self):
        ...
        self.listFrame.pack(side=tk.TOP, fill=tk.BOTH, expand=True)
        self.crudFrame.pack(side=tk.BOTTOM)
        self.listFrame.update()
        self.crudFrame.update()
        self.cacheLabel = tk.Label(self.listFrame,text="Cache").pack()
